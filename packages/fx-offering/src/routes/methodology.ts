 ...
 *
 * NOTE (F541): Cross-boundary imports resolved for fx-offering Worker:
 *   - PmSkillsCriteriaService: was core/discovery/services → moved to ../services/
 *   - PmSkillsModule, buildAnalysisSteps, getNextExecutableSkills, detectEntryPoint,
 *     getSkillGuide: were api-level services → moved to ../services/
 *   - UpdatePmSkillsCriterionSchema: was api-level schemas → moved to ../schemas/
 *   - BizItemService: was core/discovery/services → moved to ../services/
 */
...
import { recommendMethodology } from "../services/methodology-types.js";
...
export const methodologyRoute = new Hono<{ Bindings: OfferingEnv; Variables: TenantVariables }>();
