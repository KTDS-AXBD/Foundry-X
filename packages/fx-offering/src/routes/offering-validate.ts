 ...
 *
 * NOTE (F541): Cross-boundary import resolved for fx-offering Worker:
 *   - OgdDomainRegistry: was core/harness/services → moved to ../services/
 */
...
export const offeringValidateRoute = new Hono<{ Bindings: OfferingEnv; Variables: TenantVariables }>();
