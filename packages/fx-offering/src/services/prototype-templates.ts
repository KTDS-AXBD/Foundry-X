...
function renderHero(data: PrototypeData, _theme: ReturnType<typeof getTheme>): string {
...
function renderSolution(data: PrototypeData, _theme: ReturnType<typeof getTheme>): string {
...
function renderCta(data: PrototypeData, _theme: ReturnType<typeof getTheme>): string {
