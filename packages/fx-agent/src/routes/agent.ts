...
export const agentRoute = new OpenAPIHono<{ Bindings: AgentEnv }>();
...
function createPrPipeline(env: AgentEnv, sseManager?: SSEManager) {
...
function createMergeQueue(env: AgentEnv, sseManager?: SSEManager): MergeQueueService {
  const github = new GitHubService(env.GITHUB_TOKEN, env.GITHUB_REPO ?? "");
