...
import { McpResourcesClient } from "../src/services/mcp-resources.js";
import type { McpServerRegistry, McpServerRecord } from "../src/services/mcp-registry.js";
...
vi.mock("../src/services/mcp-transport.js", () => ({
  createTransport: () => ({
    type: "http",
