...
> = {
  "claude-code": {
    ...
    badge: "권장",
    desc: "터미널에서 claude 명령으로 실행. ax plugin(21개 워크플로우 스킬) + CLAUDE_AXBD(76개 BD 분석 스킬) 모두 사용 가능.",
  },
  "claude-desktop": {
    icon: Monitor,
  ...
  "claude-code": [
    {
      ...
      description:
        "세션 관리, Sprint, 거버넌스, 요구사항 관리 등 21개 개발 워크플로우 스킬을 설치해요.",
  ...
  const resources = [
    {
      ...
      desc: "21개 워크플로우 스킬 — 세션/Sprint/거버넌스/요구사항",
