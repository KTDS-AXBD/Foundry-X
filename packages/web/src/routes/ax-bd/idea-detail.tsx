...
import { fetchIdeaDetail, type IdeaDetail } from "@/lib/api-client";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Link to="/ax-bd/ideas" className="text-muted-foreground hover:text-foreground"><ArrowLeft className="size-5" /></Link>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="rounded-lg border p-4">
          ...
          <div className="text-sm font-medium">{item.syncStatus}</div>
        </div>
        <div className="rounded-lg border p-4">
