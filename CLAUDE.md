...
- packages/api: Hono API 서버 (28 endpoints OpenAPI, 14 services, 136 테스트)
- packages/web: Next.js 14 대시보드+랜딩 (9 pages, 34 테스트, shadcn/ui, Digital Forge, Playwright E2E)
- 다음 단계: Sprint 12 — MCP 실 구현 + agents-page 테스트 + v1.0.0 릴리스 준비 (상세: `docs/specs/prd-v4.md`)
