...
- packages/api: Hono API 서버 (17 endpoints OpenAPI, 43 테스트)
- packages/web: Next.js 14 대시보드 (6 pages, 27 테스트, shadcn/ui)
- 다음 단계: Sprint 8 — 실데이터 완성 + SSE + NL→Spec (상세: `docs/specs/prd-v4.md`)
...
- **Phase 2 Sprint 8:** 📋 계획 — API 완성 + SSE + NL→Spec
  - F44 SSE, F45 NL→Spec, F46 Wiki Git 동기화
