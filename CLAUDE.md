...
**현재 상태:** v1.5.0 — Sprint 17 완료 (AI Foundry MCP 연동+AgentInbox 스레드+PlannerAgent Orchestrator, Match Rate 98%, 313 API tests + 20 E2E)
...
- packages/api: Hono API 서버 (57 endpoints, 21 services, 307 테스트)
...
- Sprint 15 완료: PlannerAgent + AgentInbox + WorktreeManager + v1.3.0 (307 API tests, PDCA 92%)
- Sprint 16 완료: PlannerAgent LLM 실 연동 + AgentInboxPanel UI + v1.4.0 (313 API tests, PDCA 91%)
- Sprint 17 완료: AI Foundry MCP 연동 + AgentInbox 스레드 + PlannerAgent Orchestrator + v1.5.0 (313 API tests, PDCA 98%)
...
| `docs/01-plan/features/sprint-{N}.plan.md` | Sprint별 Plan (3~16) |
| `docs/02-design/features/sprint-{N}.design.md` | Sprint별 Design (3~16) |
...
- **Phase 2:** ✅ 완료 (Sprint 6~17) — v1.5.0
  ...
  - 최종: 21 services, 59 endpoints, 313 API tests + CLI 106 + Web 45 + 20 E2E
