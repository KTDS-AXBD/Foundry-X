...
| build | ✅ |
| lint | ✅ (0 error) |
| tests | API **2142** + CLI **149** + Web **230** = **2521** + E2E (25 specs) |
| API endpoints | **~370개** (66 routes) |
| API services | **156개** |
| API schemas | **81개** |
| D1 migrations | **0001~0075** |
| D1 remote | 0001~0075 전체 적용 완료 |
| Workers | foundry-x-api.ktds-axbd.workers.dev ✅ Sprint 88 (089a646a, wrangler 4.78) |
| Pages | fx.minu.best ✅ |
