...
| Sprint 98 | Phase 9: BD 팀 공용 스킬 GitHub 배포 준비(F267) — CLAUDE_AXBD 정리 + 리포 공유 | 📋 |
...
| F267 | BD 팀 공용 스킬 GitHub 배포 준비 — CLAUDE_AXBD 폴더 정리(76 skills + 36 commands + rules), 기존 axbd/ 리소스 통합, ax-bd-discovery 스킬 참조 갱신, README 배포 가이드 (FX-REQ-259, P1) | Sprint 98 | 🔧 | docs/specs/axbd-skill/CLAUDE_AXBD, 병렬 가능 |
