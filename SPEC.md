...
| C23 | C | phase_recover worker inactivity → retry queue (FX-REQ-517) | — | PLANNED | task orchestrator |
<!-- /fx-task-orchestrator-backlog -->
