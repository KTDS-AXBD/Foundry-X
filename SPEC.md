...
- **Phase**: **Phase 21** ✅ 완료 — Gate-X 독립 서비스 F402~F413 | **Phase 22** ✅ 완료 — Offering Skill v2 + Builder v2 F414~F431 | **Phase 23** ✅ 완료 — Sprint Automation v2 F432~F433 (Match 98%) | **Phase 24** ✅ 완료 — Discovery Native F434~F440 (Match 97%) | **Phase 25** ✅ 완료 — Discovery Pipeline v2 F441~F450 (Sprint 213~218, Match ~99%) | **Phase 26** 🔧 진행 — BD Portfolio Management F451~F460 (Sprint 219~)
- **Sprint**: 148~164 (✅)
...
| F454 | 1차 PRD 자동 생성 — 사업기획서 HTML 파싱 → PRD 자동 생성 (FX-REQ-446, P0) | Sprint 220 | 📋 | 4건 아이템 대상. F452 선행 |
| F455 | 2차 PRD 보강 — req-interview 스킬 거쳐 추가 요구사항 반영 PRD (FX-REQ-447, P0) | Sprint 220 | 📋 | F454 선행. HITL 인터뷰 기반 |
| F456 | 최종 PRD 확정 — PDCA plan/design 거쳐 확정 PRD 생성 + 버전 관리 (FX-REQ-448, P0) | Sprint 221 | 📋 | F455 선행. 3단계 PRD 모두 검색/편집 가능 |
| **Phase 26-C: Prototype 생성 + 연결 (M3, P1)** | | | | |
| F457 | Prototype Builder 실행 — 등록된 아이템 2건 대상 Prototype 자동 생성 (FX-REQ-449, P1) | Sprint 222 | 📋 | F456 선행. Deny v2 + 1건 추가 |
| F458 | Prototype 등록 — 생성된 Prototype을 shaping/prototype에 등록 + Offering 연동 (FX-REQ-450, P1) | Sprint 222 | 📋 | F457 선행. offering_prototypes 연결 |
| **Phase 26-D: E2E 검색/편집 인프라 (M4, P1)** | | | | |
| F459 | 포트폴리오 연결 구조 검색 — 사업아이템→분석→평가결과서→사업기획서/Offering→PRD→Prototype 전체 연결 조회 API (FX-REQ-451, P1) | Sprint 223 | 📋 | 전체 파이프라인 이력 통합 |
| F460 | 포트폴리오 대시보드 — 등록된 사업 아이템 전체 현황 + 문서 연결 시각화 (FX-REQ-452, P1) | Sprint 223 | 📋 | F459 선행. Discovery 페이지 확장 |
