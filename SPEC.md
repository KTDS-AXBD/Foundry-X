...
| Sprint 139 | 📋 (F322+F329) — 사이드바 구조 재설계 + Blueprint 랜딩 전환 | Phase 13 + 독립 트랙 병렬 |
...
| F329 | Blueprint 랜딩 페이지 전면 전환 — landing.tsx 7개 섹션 설계도 스타일 리디자인 (플로우차트 Process, 시스템 다이어그램 Architecture, Gantt Roadmap, 회로도 Agents), bp-* CSS 적용, 다크 모드, 반응형 유지 (FX-REQ-321, P2) | Sprint 139 | 📋 | 독립 트랙. design-shotgun variant-C 승인 (세션 #198). FX-PLAN-015 |
