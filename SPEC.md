...
| F566 | **Phase 45 · MSA Separation Roadmap v2** — Gap 8 해소. 6 도메인 분리 우선순위 + 일정 명문화 문서. 범위: (a) `docs/specs/fx-msa-roadmap-v2/prd-final.md` v2 발행, (b) 각 도메인 리소스/일정/롤백 시나리오, (c) Sprint 311~318 배치 근거, (d) Phase 46+ 예측 로드맵 (FX-REQ-609, P0) | Sprint 311 | 🔧(design) | S302+ 착수. PRD §3-1 F566. F560과 병렬, 문서-only meta |
