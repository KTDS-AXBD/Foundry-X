...
| C12 | C | prd-v8 governance compliance rename and frontmatter (FX-REQ-504) | — | PLANNED | task orchestrator |
| C13 | C | sprint-pipeline-monitor and post-session docs ax-plugin (FX-REQ-505) | — | PLANNED | task orchestrator |
| X5 | X | long term backlog reevaluation F112 F117 F118 F245 (FX-REQ-506) | — | PLANNED | task orchestrator |
| X6 | X | multi account ax plugin sync symlink hub extension (FX-REQ-507) | — | PLANNED | task orchestrator |
<!-- /fx-task-orchestrator-backlog -->
