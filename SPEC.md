...
- **Phase**: **Phase 18** ✅ 완료 — Offering Pipeline F363~F383 | **Phase 19** ✅ ��료 — Builder Evolution F384~F391 | **Phase 20** ✅ 완료 — AX BD MSA F392~F401 (Match 94%) | **Phase 21** 🔧 진행 중 — Gate-X 독립 서���스 F402~F412 (Sprint 189~196, 11건)
- **Sprint**: 148~164 (✅)
...
| F402 | Gate-X 독립 Workers 프로젝트 scaffold + wrangler.toml + D1 전용 DB 생성 (FX-REQ-394, P0) | Sprint 189 | 🔧 | harness-kit scaffold 기반. 새 D1 DB (gate-x-db) |
| F403 | Gate 모듈 추출 — 7 routes + 7 services + 6 schemas 독립 Workers 이전 (FX-REQ-395, P0) | Sprint 189 | 🔧 | modules/gate/ → Gate-X API. Tenant ID 초기 포함 |
| F404 | O-G-D 루프 비동기 아키텍처 — Cloudflare Queues + Durable Objects PoC (FX-REQ-396, P0) | Sprint 190 | 📋 | Workers CPU time 제한 해소. 핵심 기술 리스크 검증 |
| F405 | JWT 독립 인증 + API Key 발급 + RBAC + CI/CD 파이프라인 (FX-REQ-397, P0) | Sprint 190 | 📋 | harness-kit JWT/RBAC. GitHub Actions deploy.yml |
