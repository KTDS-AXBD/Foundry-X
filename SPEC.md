...
- **Sprint**: 99 (진행 중) — ax-config Plugin 전환 (F268)
...
| F268 | ax-config Plugin 전환 — Command/Skill 중복 정리(20개), ax-config Git 정비, Plugin 형식 변환(plugin.json+marketplace), 팀 설치 가이드 (FX-REQ-260, P1) | Sprint 99 | 📋 | |
