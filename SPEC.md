...
| F323 | 대시보드 ToDo List + 업무 가이드 — 파이프라인 현황 + 아이템별 단계 표시 + 체크리스트 + 의사결정 대기 알림 + 4단계 검증·제품화·개발 가이드 (FX-REQ-315, P1) | Sprint 141 | 📋 | v1.3 §5.1/§5.2. F322 선행 ✅ |
| F324 | 발굴 탭 통합 — 3탭(대시보드/프로세스/BMC) + 멀티 페르소나 프로세스 내 통합 + 평가 결과서 + 스킬카탈로그→위키 이동 (FX-REQ-316, P1) | Sprint 141 | 📋 | v1.3 §3.3/§4. F322 선행 ✅ |
