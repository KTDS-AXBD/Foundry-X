...
> ```
> **마지막 실측** (Sprint 210, 2026-04-08): ~9 routes, ~37 services (adapters 10 포함), ~13 schemas, D1 0116, tests ~3168 (E2E 263) — Phase 20-21 MSA 재조정으로 core/modules가 gate-x·harness-kit으로 이전
