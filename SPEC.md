...
| F171 | 대시보드 IA 재설계 — 업무 동선 중심 메뉴 구조 재편 + 중복 메뉴 통합 + 역할별 랜딩 (FX-REQ-171, P0) | Sprint 49 | 📋 | 3대 동선: SR→분석→제안서, 아이디어→Spec→에이전트, 프로젝트 모니터링 |
| F172 | 인터랙티브 온보딩 투어 — 첫 로그인 가이드 + 스텝별 툴팁 + 업무별 퀵스타트 (FX-REQ-172, P1) | Sprint 49 | 📋 | F171 IA 재설계 완료 후 적용, react-joyride 기반 |
