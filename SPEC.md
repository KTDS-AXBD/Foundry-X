...
| Sprint 147 | 🔧 (F332) — 랜딩 콘텐츠 리뉴얼: BDP 6+1, 에이전트 3그룹, 시스템 구성도, 오픈소스 연계, 히어로 직설형 | 독립 트랙. F329 후속 |
...
| **랜딩 페이지 콘텐츠 리뉴얼** | | | | |
| F332 | 랜딩 콘텐츠 리뉴얼 — BDP 6+1단계 수정, 3대 차별점(BDP+AI에이전트+오케스트레이션), 에이전트 3그룹(발굴/형상화/실행), 아키텍처→시스템 구성도 1장, 생태계→오픈소스 연계, 로드맵 축소, Stats 사용자 중심, 히어로 직설형 메시지. Blueprint 시각화 강화 (FX-REQ-324, P1) | Sprint 147 | 🔧 | 독립 트랙. F329 후속. 시각화 중요 |
