...
| F466 | Feedback → Regeneration 루프 — feedback_pending Job의 피드백을 Generator에 전달하여 재생성 (FX-REQ-458, P0) | Sprint 228 | 📋 | ogd-orchestrator + feedback-service 연결 |
| F467 | Quality 데이터 통합 — ogd_rounds → prototype_quality 자동 적재 + 5차원 분해 (FX-REQ-459, P0) | Sprint 228 | 📋 | ogd-orchestrator 완료 시점 INSERT |
| **Phase 27-C: BD Sentinel 통합 (M3, P0)** | | | | |
| F468 | BD Sentinel 구현 — 7+ Sector 자율 감시 메타 오케스트레이터 + DDPEV 사이클 (FX-REQ-460, P0) | Sprint 229 | 📋 | prototype-sentinel→bd-sentinel 확장 |
