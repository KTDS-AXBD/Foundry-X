...
| C9 | C | Offering PPTX 생성 품질 보강 (FX-REQ-490) | — | PLANNED | task orchestrator |
| X3 | X | puppeteer-mcp 설치 및 워크플로우 통합 (FX-REQ-491) | — | PLANNED | task orchestrator |
| X4 | X | RFP 기반 제안서 Agent PRD 작성 (FX-REQ-492) | — | PLANNED | task orchestrator |
<!-- /fx-task-orchestrator-backlog -->
