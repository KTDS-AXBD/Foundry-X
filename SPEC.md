...
| Sprint 92 | 📋 계획 (F255) — GIVC Ontology PoC 1차 (KG 스키마 + 샘플 데이터 + 질의 API) |
...
| Sprint 92 | Phase 9: GIVC Ontology PoC 1차(F255) | 📋 |
...
| F255 | GIVC Ontology PoC 1차 — 산업 공급망 지식그래프 스키마 설계 + 샘플 데이터 로드 + 기본 질의 API (FX-REQ-247, P2) | Sprint 92 | 📋 | F245 구체화. KG 스키마 + D1 or 외부 DB |
