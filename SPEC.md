...
| ID | 제목 | Sprint | 상태 | 비고 |
|----|------|--------|:----:|------|
| C1 | S-alpha dogfood smoke test (FX-REQ-pending) | — | 🔧 | task orchestrator |
<!-- /fx-task-orchestrator-backlog -->
