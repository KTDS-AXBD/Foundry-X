...
| ID | 제목 | Sprint | 상태 | 비고 |
|----|------|--------|:----:|------|
| C1 | discovery analysis process audit (FX-REQ-pending) | — | 🔧 | task orchestrator |
| C2 | discovery analysis process audit (FX-REQ-pending) | — | 🔧 | task orchestrator |
| X1 | task-orchestrator s-beta heartbeat signal (FX-REQ-pending) | — | 🔧 | task orchestrator |
| C3 | claude-code 200k context token optimization (FX-REQ-pending) | — | 🔧 | task orchestrator |
