...
| F# | 제목 (REQ, Priority) | 버전 | 상태 | 비고 |
|----|----------------------|:----:|:----:|------|
| F26 | 팀 정보 공유 대시보드 (FX-REQ-026, P1) | v0.5 | 📋 | 공동 목표 인지 + 현황 공유 화면 |
| F27 | Human Readable Document + Wiki (FX-REQ-027, P1) | v0.5 | 📋 | 문서 뷰어 + Wiki 구성 |
| F28 | 아키텍처 뷰 (FX-REQ-028, P1) | v0.5 | 📋 | 아키텍처 도식화, BluePrint, Roadmap, ChangeLog, Version, 요구사항 관리(백로그→협의→계획 전환) |
| F29 | 개인 워크스페이스 (FX-REQ-029, P1) | v0.5 | 📋 | ToDo List, Message box, Setting 등 개인별 업무 공간 |
| F30 | Agent 투명성 뷰 (FX-REQ-030, P1) | v0.5 | 📋 | Agent 작업 현황·요청 방법 시각화 (동료로서의 AI) |
| F31 | Token/비용 관리 (FX-REQ-031, P1) | v0.5 | 📋 | API 비용 처리, LLM Fallback, AI Gateway 관리 |
...
**Part A: Frontend Design**
- [ ] 팀 정보 공유 대시보드 (FX-REQ-026 PLANNED)
- [ ] Human Readable Document + Wiki (FX-REQ-027 PLANNED)
- [ ] 아키텍처 뷰 — 도식화, BluePrint, Roadmap, ChangeLog, Version, 백로그 관리 (FX-REQ-028 PLANNED)
- [ ] 개인 워크스페이스 — ToDo, Message, Setting (FX-REQ-029 PLANNED)
- [ ] Agent 투명성 뷰 — 작업 현황·요청 방법 시각화 (FX-REQ-030 PLANNED)
- [ ] Token/비용 관리 — API 비용, LLM Fallback, AI Gateway (FX-REQ-031 PLANNED)
