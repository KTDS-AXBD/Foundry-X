...
> ```
> **마지막 실측** (Sprint 263, 2026-04-12): ~10 routes, ~28 services, ~14 schemas, D1 0126, tests ~3452 (E2E 273) — Phase 35 F511 Work Management 품질 보강: T3 SQL injection 방어 + T4 ORDER BY CASE WHEN + G1 에러 핸들링 UI + E2E 6→11건(+5)
...
| — | **Phase 36: Work Management Enhancement** — Blueprint/Roadmap 도입 + SPEC 경량화 + 기존 데이터 시각화 + TDD (F512~F515) | 📋 |
| Sprint 264 | Phase 36-B: API 테스트 보강 + 확장 (F513, TDD) | 📋 |
| Sprint 265 | Phase 36-B: 대시보드 확장 (F514) | 📋 |
| Sprint 266 | Phase 36-C: 자동화 연결 (F515) | 📋 |
...
| F512 | 문서 체계 정비 + 아카이브 — A-0 파서 테스트 보강 + BLUEPRINT.md/ROADMAP.md 도입 + SPEC.md 경량화(1377→350줄) + docs/ 아카이브(400→100파일) + F-item 세부 상태 10단계 + Entry/Exit Criteria (FX-REQ-535, P0) | — | 📋 | meta-only, Sprint 불요. A-0(파서 테스트) 선행 후 A-1~A-8 단계적 진행 |
