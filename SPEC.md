...
- **Phase**: Phase 4 Conditional Go — Sprint 26~30 완료, 온보딩 데이터 대기
- **Version**: 2.4.0
...
| v2.5 | Sprint 31: 프로덕션 완전 동기화 + SPEC 정합성 + Match Rate 보강 + 온보딩 킥오프 + 로그인 UI (F129~F133) | 📋 |
...
- [ ] D1 migration 0018~0019 remote 적용 (FX-REQ-129)
- [ ] Workers v2.4.0 프로덕션 배포 + smoke test 6 endpoints (FX-REQ-129)
- [ ] SPEC.md §1/§2/§3 보정 — Phase 설명, system-version, 마일스톤, D1 remote 상태 (FX-REQ-130)
- [ ] Sprint 29/30 Execution Plan 체크박스 동기화 (FX-REQ-130)
- [ ] MEMORY.md 보정 — Workers/D1/다음작업 갱신 (FX-REQ-130)
- [ ] ServiceContainer FX_NAVIGATE router.push 연결 + serviceName breadcrumb (FX-REQ-131)
- [ ] E2E 보강 — ErrorResponse 검증 + Harness Rules API + 온보딩 플로우 + KPI 대시보드 (FX-REQ-131)
- [ ] 온보딩 킥오프 체크리스트 문서 — 시나리오 5종 + 대상자 + 프로세스 (FX-REQ-132)
...
| F# | 제목 (REQ, Priority) | 버전 | 상태 | 비고 |
|----|----------------------|:----:|:----:|------|
| F129 | 프로덕션 완전 동기화 — D1 0018~0019 remote + Workers v2.4.0 배포 + smoke test (FX-REQ-129, P0) | v2.5 | 📋 | Sprint 31 |
| F130 | SPEC/문서 정합성 보정 — §1/§2/§3 갱신 + Execution Plan 체크박스 + MEMORY 동기화 (FX-REQ-130, P0) | v2.5 | 📋 | Sprint 31, drift 9건 |
| F131 | Phase 4 잔여 Match Rate 보강 — F128 E2E 72%→90%+ / F124 FX_NAVIGATE 연결 86%→90%+ (FX-REQ-131, P1) | v2.5 | 📋 | Sprint 31 |
| F132 | 온보딩 킥오프 체크리스트 — 시나리오 5종 + 프로세스 문서 + 킥오프 준비 (FX-REQ-132, P1) | v2.5 | 📋 | Sprint 31, PRD v5 §7.17 연계 |
