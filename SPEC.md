...
| build | ✅ |
| lint | ✅ (0 error) |
| tests | 366테스트 ✅ (API 패키지) + CLI 106 + Web 45 + 20 E2E |
| API endpoints | 61개 (14 routes) |
| API services | 29개 |
| D1 tables | 24개 (migrations 0001~0012) |
| D1 remote | ✅ 전부 적용 완료 |
...
| F# | 제목 (REQ, Priority) | 버전 | 상태 | 비고 |
|----|----------------------|:----:|:----:|------|
| F92 | 멀티테넌시 고도화 — org 전환 UI, org별 격리 강화, 초대/권한 관리 (FX-REQ-092, P1) | v1.8+ | 🔧 | — |
| F93 | GitHub 양방향 동기화 고도화 — PR 자동 리뷰 실 연동, Issue→Task 자동 생성 (FX-REQ-093, P1) | v1.8+ | 📋 | — |
