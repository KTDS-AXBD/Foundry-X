...
| C28 | C | task-start.sh HOME propagation + inject --model sonnet for WT workers (FX-REQ-522) | — | PLANNED | task orchestrator |
<!-- /fx-task-orchestrator-backlog -->
