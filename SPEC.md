...
| API endpoints | **~239개** (42 routes) |
| API services | **122개** |
| API schemas | **53개** |
| D1 migrations | **0001~0050** |
| D1 remote | 0001~0050 전체 적용 완료 |
| Workers | foundry-x-api.ktds-axbd.workers.dev ✅ Sprint 64 (391742fe) |
| Pages | fx.minu.best ✅ |
