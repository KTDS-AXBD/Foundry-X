...
- **Phase**: **Phase 11** 진행 중 (Sprint 113~120 완료) — IA 대개편 11/12 완료 (F288~F298 ✅, F299 📋)
- **Sprint**: 121 (진행) — 대고객 선제안 GTM (F299)
- **Phase 11 F-items**: F288~F298 ✅ (11건 완료), F299 🔧 (Sprint 121 진행)
...
| **Phase 11** | 🔧 진행 — IA 대개편 F288~F299 (11/12 완료) | 11-A ✅, 11-B ✅ (115~119), 11-C 2/3 ✅ (118~120). F299 미착수 |
| Sprint 122 | 📋 E2E 테스트 종합 정비 (F300) — 16 fail 수정 + API-only 정리 + redirect 검증 + 주기적 점검 체계 | 인프라/품질. Phase 11과 병렬 |
| Sprint 123 | 🔧 BD 산출물 UX 연결성 (F301) — discovery-detail 강화 + Pipeline 드릴다운 + MVP 역링크 | 인프라/UX. F300과 병렬 가능 |
...
| F299 | 대고객 선제안 GTM — 6단계 GTM에 고객 선제안 워크플로 + 제안서 자동 생성 (FX-REQ-291, P4) | Sprint 121 | 🔧 | G11. /gtm/outreach. D1 0088 + API 11ep + Web 2p + ~47 tests. FX-PLAN-121 |
