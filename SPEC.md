...
- **Sprint**: 97 (완료) — 발굴 UX 통합 QA + 팀 데모 (F263~F266)
...
| 5.47 | 2026-04-01 | F263~F266 전체 완료 — Sprint 94~97 ✅. 위저드 UI+Help Agent(OpenRouter SSE+Hybrid)+온보딩 투어+HITL 패널+E2E 4 spec+Feature Flag. 54 files, +5601 lines. 수치: 73 routes/169 svc/87 schemas/D1 0078/API 2250+CLI 149+Web 265 |
