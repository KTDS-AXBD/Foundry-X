...
- **Phase**: Phase 3 진행 중 (멀티테넌시 + 외부 도구 연동) — Sprint 18~24 완료
- **Version**: 2.0.0
...
| build | ✅ |
| lint | ✅ (0 error) |
| tests | 535테스트 ✅ (API 패키지) + CLI 106 + Web 48 + ~51 E2E |
| API endpoints | 97개 (20 routes) |
| API services | 39개 |
| D1 tables | 27개 (migrations 0001~0016) |
| D1 remote | ✅ 전부 적용 완료 |
| Workers | foundry-x-api.ktds-axbd.workers.dev ✅ v2.0.0 |
| Pages | fx.minu.best ✅ |
...
| v2.1 | Phase 3 완성: 기술 스택 점검(F98) + 기반 완성(F99~F103) + AXIS DS 전환(F104) + Plumb 판정(F105) | 📋 |
| v2.2 | Phase 4 전반: 프론트엔드 통합(F106) + 인증 SSO(F108) | 📋 |
| v2.3 | Phase 4 후반: API 통합(F109) + D1 통합(F111) + 온보딩(F114) | 📋 |
...
| F# | 제목 (REQ, Priority) | 버전 | 상태 | 비고 |
|----|----------------------|:----:|:----:|------|
| F98 | 기술 스택 점검 스프린트 — Discovery-X/AI Foundry/AXIS DS 호환성 분석 + 매트릭스 작성 (FX-REQ-098, P0) | v2.1 | 🔧 | Sprint 25, PRD v5 §7.13 |
...
| F# | 제목 (REQ, Priority) | 버전 | 상태 | 비고 |
|----|----------------------|:----:|:----:|------|
| F104 | AXIS DS UI 전환 — shadcn/ui → AXIS DS 컴포넌트 + 디자인 토큰 통합 (FX-REQ-104, P1) | v2.1 | 🔧 | Sprint 25, F79 후속 |
