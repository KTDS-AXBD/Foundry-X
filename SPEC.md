...
| F459 | 포트폴리오 연결 구조 검색 — Portfolio Graph API + 역조회 + 커버리지 (FX-REQ-451, P1) | Sprint 223→224 | 🔧 | Graph API 완료. List/Reverse Lookup 보강 중 (Match 53%→iterate) |
| F460 | 포트폴리오 대시보드 — 카드목록 + 연결그래프 + 산출물미리보기 (FX-REQ-452, P1) | Sprint 223→224 | 🔧 | UI 기본 완료. 미리보기+편집링크 보강 중 |
