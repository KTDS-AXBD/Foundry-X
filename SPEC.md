...
| Sprint 2 | ✅ 코드 완료 (커맨드 3개 + 템플릿 + CI), npm publish 대기 |
...
| F11 | npm publish + 온보딩 (FX-REQ-011, P1) | v0.2 | 📋 | npx foundry-x init 미검증 |

### 미래 작업

| F# | 제목 (REQ, Priority) | 버전 | 상태 | 비고 |
|----|----------------------|:----:|:----:|------|
| F12 | ADR-000 작성 (FX-REQ-012, P2) | v0.2 | 📋 | v3→v4 대체 선언 |
| F13 | .plumb 출력 + decisions.jsonl 내부 계약 (FX-REQ-013, P2) | v0.2 | 📋 | 데이터 포맷 문서화 |
| F14 | subprocess 오류 처리 계약 (FX-REQ-014, P2) | v0.2 | 📋 | timeout, exit code, stderr |
...
- [ ] npm publish + npx 검증 (FX-REQ-011 PLANNED)
- [ ] ADR-000 작성 (FX-REQ-012 PLANNED)
- [ ] 내부 계약 문서 2건 (FX-REQ-013, FX-REQ-014 PLANNED)
...
| TD# | 등록일 | 항목 | 영향 |
|-----|:------:|------|------|
| TD-01 | 2026-03-16 | index.ts에 Commander 설정 미구현 (placeholder) | Sprint 2에서 해소 예정 |
