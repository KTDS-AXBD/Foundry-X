...
| F547 | **fx-ai-foundry-os: 퇴직연금 Type 1 시연 페이지** — `/ai-foundry-os/demo/pension` — Decode-X 3-Pass(scoring/diagnosis/comparison) 결과 시각화 + "Type 1 반제품(Code+Test)" 다운로드 버튼. 실제 다운로드는 기존 퇴직연금 SI 코드에서 추출한 템플릿 zip (R7 단순화). 성공 KPI: 대표 보고 rehearsal walkthrough 통과. PRD: `docs/specs/fx-ai-foundry-os/prd-final.md` (FX-REQ-583, P0) | Sprint 298 | 📋(plan) | F546 선행 필수. R7(AI 자동생성 품질 리스크) 대응으로 템플릿 기반 단순화 |
