...
| C14 | C | E2E smoke A — lib.sh + task-start.sh static checks (FX-REQ-508) | — | PLANNED | task orchestrator |
| C15 | C | E2E smoke B — task-complete + daemon guard checks (FX-REQ-509) | — | PLANNED | task orchestrator |
<!-- /fx-task-orchestrator-backlog -->
