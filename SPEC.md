...
| C51 | C | Monitor lifecycle 관리 — sprint skill done/merge에 Monitor stop 추가 + signal에 MONITOR_TASK_ID 기록 + session-start stale 감지 (FX-REQ-559) | — | PLANNED | task orchestrator |
<!-- /fx-task-orchestrator-backlog -->
