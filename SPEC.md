...
| F327 | 제품화 탭 통합 + Offering Pack — MVP/PoC 2탭 + Offering Pack 버전관리 (FX-REQ-319, P3) | Sprint 143 | 📋 | v1.3 §3.6. F322 선행 ✅ |
| F328 | 시작하기 통합 + 공통 메뉴 정리 — 5영역(온보딩+스킬가이드+Cowork+데모+도구가이드) + 팀공유→산출물 흡수 (FX-REQ-320, P3) | Sprint 143 | 📋 | v1.3 §3.1/§4. F322 선행 ✅ |
