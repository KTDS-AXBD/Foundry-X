...
| build | ✅ |
| lint | ✅ (0 error) |
| tests | 471테스트 ✅ (API 패키지) + CLI 106 + Web 48 + 20 E2E |
| API endpoints | 79개 (16 routes) |
| API services | 31개 |
| D1 tables | 26개 (migrations 0001~0014) |
| D1 remote | ✅ 전부 적용 완료 |
...
| F95 | PlannerAgent 고도화 — 실 LLM 기반 코드베이스 분석 정확도 개선 (FX-REQ-095, P2) | v1.8+ | 🔧 | Sprint 22 |
