...
- **Phase**: Phase 2 (API + Web + 에이전트 오케스트레이션) — Sprint 6 완료, Sprint 7 준비
- **Version**: 0.6.0
...
| build | ✅ |
| lint | ✅ (0 error) |
| tests | 38파일 145테스트 ✅ (CLI 106 + API 39) |
...
| F38 | OpenAPI 3.1 계약서 + API 리팩토링 (FX-REQ-038, P1) | v0.7 | 📋 | Sprint 7 이관 (Sprint 6 Match 15%) |
...
| F# | 제목 (REQ, Priority) | 버전 | 상태 | 비고 |
|----|----------------------|:----:|:----:|------|
| F38 | OpenAPI 3.1 계약서 + API 리팩토링 (FX-REQ-038, P1) | v0.7 | 📋 | Sprint 6에서 이관 |
| F41 | API 엔드포인트 실데이터 연결 (FX-REQ-041, P1) | v0.7 | 📋 | D1 + GitHub API로 data-reader 전환 |
| F42 | shadcn/ui + 웹 컴포넌트 고도화 (FX-REQ-042, P1) | v0.7 | 📋 | shadcn/ui 도입, 반응형, 다크모드 |
| F43 | API + Web 테스트 스위트 (FX-REQ-043, P1) | v0.7 | 📋 | Hono test helper + D1 mock, React Testing Library |
...
- [ ] OpenAPI 3.1 계약서 — Sprint 7 이관 (FX-REQ-038, Match 15%)
