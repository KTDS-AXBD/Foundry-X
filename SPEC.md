...
| F461 | Prototype QSA 구현 — 5차원 품질/보안 Discriminator + First Principles Gate + CSS 정적 분석 (FX-REQ-453, P0) | Sprint 226 | 📋 | prototype-qsa.md 설계 완료 → 코드 연동 |
| F462 | Offering QSA 구현 — HTML/PPTX 품질/보안/디자인 판별 + 18섹션 구조 검증 (FX-REQ-454, P0) | Sprint 226 | 📋 | offering-qsa.md 신규 설계+구현 |
...
| F464 | Generation–Evaluation 정합성 — impeccable 7도메인 ↔ Discriminator 체���리스트 자동 정렬 (FX-REQ-456, P0) | Sprint 228 | 📋 | prototype-ogd-adapter.ts 수정 |
| F465 | Design Token → Generation 연결 — DesignTokenService 토큰을 prototype-styles.ts에 주입 (FX-REQ-457, P0) | Sprint 228 | 📋 | prototype-styles.ts 확장 |
| F466 | Feedback → Regeneration 루프 — feedback_pending Job의 피드백을 Generator에 전달하여 재생성 (FX-REQ-458, P0) | Sprint 229 | 📋 | ogd-orchestrator + feedback-service 연결 |
| F467 | Quality 데이터 통합 — ogd_rounds → prototype_quality 자동 적재 + 5차원 분해 (FX-REQ-459, P0) | Sprint 229 | 📋 | ogd-orchestrator 완료 시점 INSERT |
| **Phase 27-C: BD Sentinel 통합 (M3, P0)** | | | | |
| F468 | BD Sentinel 구현 — 7+ Sector 자율 감시 메타 오케스트레이터 + DDPEV 사이클 (FX-REQ-460, P0) | Sprint 230 | 📋 | prototype-sentinel→bd-sentinel 확장 |
| **Phase 27-D: 디자인 고도화 (P1)** | | | | |
| F469 | CSS Anti-Pattern Guard — 생성 시점 AI 기본 폰트/순수 흑백/비배수 spacing 사전 차단 (FX-REQ-461, P1) | Sprint 231 | 📋 | styleseed+impeccable 원칙 적용 |
| F470 | HITL Review → Action 연결 — revision_requested 리뷰가 피드백→재생성 자동 트리거 (FX-REQ-462, P1) | Sprint 231 | 📋 | review-service → feedback-service 연결 |
